...
CREATE TABLE IF NOT EXISTS bot_config(
    lara_name TEXT DEFAULT 'Duck and Gov ',                                  -- Nome da lara
    lara_key TEXT DEFAULT 'abcd3fg-559d-4a9c-94ff-2631ea6d80d4',                                    -- Chave pix da lara
    main_img TEXT DEFAULT 'https://telegra.ph/Vamos-alugar-sua-Store-dukstd3v-06-10',  -- Link da imagem do /start
    support_user TEXT DEFAULT '@dukstd3v',                                    -- Username de atendimento
    channel_user TEXT DEFAULT '@dukstd3v',                               -- Canal de notícias
